...
// 1. Use o spread para criar uma cópia superficial de um array:
const original = [1, 2, 3];
const copia = [...original];
console.log(copia); // Saída: (3) [1, 2, 3]

// 2. O spread facilita a concatenação de arrays:
const array1 = [1, 2, 3];
const array2 = [4, 5, 6];
const concatenado = [...array1, ...array2];
console.log(concatenado); // Saída: (6) [1, 2, 3, 4, 5, 6]

// 3. Use o spread para passar elementos de um array como argumentos individuais para uma função:
...
// 4. Use também o spread para clonar e mesclar objetos:
...
// 5. Use o spread para converter uma string em um array de caracteres:
const string = 'Lucas';
